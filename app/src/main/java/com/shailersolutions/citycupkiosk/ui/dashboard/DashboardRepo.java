...
public class DashboardRepo {
  ...
  public void setAction(GetApiService api,String device_id,String mac_id,String reqd_tm){
    Call<ApiResponse> getResponse = api.getMasterReturnCreate(device_id, mac_id, reqd_tm);
